...
instance Print Frontend.Signe.Abs.Toplevel where
  prt i e = case e of
    Frontend.Signe.Abs.ToplF id patterns expr -> prPrec i 0 (concatD [prt 0 id, prt 0 patterns, doc (showString ":="), prt 0 expr])
    Frontend.Signe.Abs.ToplFT id patterns type_ expr -> prPrec i 0 (concatD [prt 0 id, prt 0 patterns, doc (showString ":"), prt 0 type_, doc (showString ":="), prt 0 expr])
  prtList _ [] = concatD []
...
instance Print Frontend.Signe.Abs.Expr where
  prt i e = case e of
    Frontend.Signe.Abs.EVar id -> prPrec i 3 (concatD [prt 0 id])
    ...
    Frontend.Signe.Abs.EMul complex expr -> prPrec i 3 (concatD [prt 0 complex, doc (showString "*"), prt 3 expr])
    Frontend.Signe.Abs.EApp expr1 expr2 -> prPrec i 2 (concatD [prt 2 expr1, prt 3 expr2])
    Frontend.Signe.Abs.EPlus expr1 expr2 -> prPrec i 1 (concatD [prt 2 expr1, doc (showString "+"), prt 1 expr2])
...
instance Print Frontend.Signe.Abs.Pattern where
  prt i e = case e of
    Frontend.Signe.Abs.PVar id -> prPrec i 0 (concatD [prt 0 id])
    Frontend.Signe.Abs.PTup id1 id2 -> prPrec i 0 (concatD [doc (showString "("), prt 0 id1, doc (showString ","), prt 0 id2, doc (showString ")")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]

instance Print Frontend.Signe.Abs.Mono where
  prt i e = case e of
    Frontend.Signe.Abs.MVar id -> prPrec i 2 (concatD [prt 0 id])
